...
export const PlatformCard = ({ platform }: PlatformCardProps) => {
  ...
  return (
    <Card
      ...
      onClick={open}
      onKeyDown={handleKey}
      className="gradient-card ramadan-card shadow-card transition-all duration-300 border-border/40 animate-fade-in overflow-hidden group cursor-pointer"
    ...
    >
      <div className="aspect-video w-full overflow-hidden relative">
        ...
        <div className="absolute top-3 right-3">
          <span className="ramadan-badge">🌙 رمضان كريم</span>
        </div>
        <div
